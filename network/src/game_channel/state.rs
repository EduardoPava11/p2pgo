...
pub async fn push_move(channel: &GameChannel, mv: Move, tag: Option<p2pgo_core::Tag>) -> Result<()> {
...
#[cfg(feature = "iroh")]
#[cfg(test)]
pub async fn handle_duplicate_move_test(channel: &GameChannel, move_record: MoveRecord) -> Result<()> {
