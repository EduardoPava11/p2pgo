...
use crate::core::{Colors, Spacing, Card, primary_button, secondary_button};
use p2pgo_neural::{training::TrainingStats, config::NeuralConfig};
...
impl TrainingView {
    ...
    pub fn show(&mut self, ui: &mut Ui) -> TrainingAction {
        ...
        ui.vertical(|ui| {
            ...
            ui.label(RichText::new("Train your AI with SGF game files").color(Colors::TEXT_SECONDARY));
    ...
    fn render_training_visualization(&self, ui: &mut Ui) {
        ...
        painter.rect_filled(
            rect,
            4.0,
            Colors::SURFACE.linear_multiply(0.8),
        );
        ...
        for i in 0..layer_count {
            ...
            for j in 0..nodes {
                ...
                let node_color = Colors::NEURAL_POLICY.linear_multiply(activation * self.training_progress);
                ...
                if i < layer_count - 1 {
                    ...
                    for k in 0..next_nodes {
                        let next_y = rect.top() + rect.height() * (k as f32 + 1.0) / (next_nodes as f32 + 1.0);
                        let next_pos = egui::Pos2::new(next_x, next_y);
                        
                        let weight = ((time * 2.0 + i as f32 + j as f32 + k as f32).sin() * 0.5 + 0.5) * self.training_progress;
