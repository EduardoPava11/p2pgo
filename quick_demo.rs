        ...
        egui::CentralPanel::default().show(ctx, |ui| {
            ...
            for i in 0..self.board_size {
                ...
                painter.line_segment(
                    [
                        Pos2::new(x, board_rect.min.y),
                        Pos2::new(x, board_rect.max.y),
                    ],
                ...
                painter.line_segment(
                    [
                        Pos2::new(board_rect.min.x, y),
                        Pos2::new(board_rect.max.x, y),
                    ],
                    Stroke::new(1.0, Color32::BLACK),
                );
            }
            ...
            if response.clicked() {
                if let Some(pos) = response.interact_pointer_pos() {
                    ...
                    if x < self.board_size && y < self.board_size {
                        ...
                        if let Ok(_) = self.game_state.apply_move(Move::Place {
                            x: x as u8,
                            y: y as u8,
                            color,
                        }) {
            ...
            ui.horizontal(|ui| {
                ...
                ui.label(format!(
                    ...
                    self.game_state.captures.0, self.game_state.captures.1
                ));
            });
