...
use egui::{Color32, Response, Ui, Widget, Vec2, Rounding, FontId};
        ...
        .show(ui, |ui| {
            ui.vertical(|ui| {
                ...
                ui.horizontal(|ui| {
                    ...
                    ui.label(egui::RichText::new(id_type.label())
                        .color(colors.text_primary)
                        .strong());
                    
                    // Info button
                    if ui.small_button("ⓘ").on_hover_text(id_type.help_text()).clicked() {
                ...
                // Description
                ui.add_space(4.0);
                ui.label(egui::RichText::new(id_type.description())
