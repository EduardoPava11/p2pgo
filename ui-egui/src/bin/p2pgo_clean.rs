...
use eframe::egui::{self, Color32, RichText, Stroke, Vec2, Pos2, Rect, FontId, FontFamily};
...
impl P2PGoApp {
    ...
    fn render_game_info(&self, ui: &mut egui::Ui) {
        ...
        ui.separator();
        ui.label(format!("Heat Map: {} (press H to toggle)", 
    ...
    fn render_training_panel(&mut self, ui: &mut egui::Ui) {
        ...
        if !self.selected_files.is_empty() {
            ...
            if !self.is_training {
                if ui.button(RichText::new("Start Training").size(18.0).color(Color32::from_rgb(220, 38, 38))).clicked() {
