...
use p2pgo_neural::{config::NeuralConfig, training::NeuralTrainer, DualNeuralNet};
use rand::Rng;
...
impl P2PGoApp {
    ...
    fn render_config_panel(&mut self, ui: &mut egui::Ui) {
        ...
        egui::Grid::new("config_grid")
            ...
            .show(ui, |ui| {
                ...
                self.render_config_slider(
                    ui,
                    "Territory Focus",
                    &mut self.neural_config.territory_focus,
                );
                self.render_config_slider(
                    ui,
                    "Fighting Spirit",
                    &mut self.neural_config.fighting_spirit,
                );
                self.render_config_slider(
                    ui,
                    "Pattern Recognition",
                ...
                self.render_config_slider(
                    ui,
                    "Risk Tolerance",
                    &mut self.neural_config.risk_tolerance,
                );
            });
    ...
    fn start_training(&mut self) {
        ...
        self.training_log
            .push_back("🧠 Initializing neural network...".to_string());
        self.training_log
            .push_back("📊 Loading game positions...".to_string());
        self.training_log
            .push_back("🔄 Starting backpropagation...".to_string());
    }
