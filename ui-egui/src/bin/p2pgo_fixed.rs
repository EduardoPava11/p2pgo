...
use p2pgo_core::{GameState, Move, Color as GoColor, Coord};
            ...
            .show(ctx, |ui| {
                ...
                ui.horizontal(|ui| {
                    ...
                    ui.with_layout(egui::Layout::right_to_left(egui::Align::Center), |ui| {
                        ui.add_space(20.0);
                        ui.label(format!("Heat Map: {} (H)", if self.show_heat_map { "ON" } else { "OFF" }));
                    });
                });
                ui.separator();
...
impl P2PGoApp {
    fn render_main_menu(&mut self, ui: &mut egui::Ui) {
        ui.vertical_centered(|ui| {
            ...
            let create_btn = egui::Button::new(RichText::new("Create Game").size(20.0))
                ...
                .fill(if self.network_ready { Color32::from_rgb(34, 197, 94) } else { Color32::from_gray(60) });
            ...
            // Join Game button
            if ui.button(RichText::new("Join Game").size(20.0))
                .min_size(Vec2::new(200.0, 50.0))
            ...
            // Offline Game button
            if ui.button(RichText::new("Offline Game").size(20.0))
                .min_size(Vec2::new(200.0, 50.0))
    ...
    fn render_board(&mut self, ui: &mut egui::Ui) {
        ...
        let board_size = 9;
        let margin = 30.0;
        let board_rect = egui::Rect::from_min_size(rect.min + Vec2::splat(margin), Vec2::splat(size - 2.0 * margin));
                ...
                if let Some(color) = self.game.board.get(y * board_size + x) {
                    ...
                    match color {
                        ...
                        GoColor::White => {
                            ...
                            painter.circle_stroke(pos, cell_size * 0.45, egui::Stroke::new(1.0, Color32::BLACK));
                        }
                    }
                }
            }
