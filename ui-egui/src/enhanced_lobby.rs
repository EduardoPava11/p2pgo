...
impl EnhancedGameLobby {
                        ...
                        ui.allocate_ui_at_rect(response_rect.shrink(5.0), |ui| {
                            ui.vertical(|ui| {
                                ...
                                ui.horizontal(|ui| {
                                    ...
                                    ui.label(format!(
                                        "({})",
                                        self.format_rank(&game.opponent.rank)
                                    ));
                                });
        ...
        if self.open_challenges.is_empty() {
            ...
            egui::ScrollArea::vertical()
                ...
                .show(ui, |ui| {
                    ...
                    sorted_challenges
                        .sort_by_key(|c| self.rank_distance(&c.challenger.rank, &my_rank));

                    for challenge in &sorted_challenges {
                        let _selected = self.ui_state.selected_challenge.as_ref()
                        ...
                        ui.group(|ui| {
                            ui.vertical(|ui| {
                                ...
                                ui.horizontal(|ui| {
                                    ...
                                    ui.label(format!(
                                        "({})",
                                        self.format_rank(&challenge.challenger.rank)
                                    ));

                                    // Reliability indicator
                                    let reliability_color =
                                        if challenge.challenger.reliability > 0.9 {
                                            Color32::GREEN
                                    ...
                                    ui.colored_label(
                                        ...
                                        format!(
                                            "⚡ {:.0}%",
                                            challenge.challenger.reliability * 100.0
                                        ),
                                    );
                                });
                                ...
                                ui.horizontal(|ui| {
                                    if ui.button("Accept").clicked() {
                                        action = Some(LobbyAction::AcceptChallenge(
    ...
    fn render_quick_actions(&mut self, ui: &mut egui::Ui) -> Option<LobbyAction> {
        ...
        ui.group(|ui| {
            ...
            ui.horizontal(|ui| {
                ui.label("Rank range:");
                ui.add(
                    egui::Slider::new(&mut self.quick_match_prefs.rank_range, 1..=9)
                        .suffix(" ranks"),
                );
            });
    ...
    fn create_time_control(&self) -> TimeControl {
        ...
        match nc.time_control_type {
            ...
            2 => TimeControl::Correspondence {
                days_per_move: nc.days_per_move,
            },
            _ => TimeControl::Rapid {
                minutes: 10,
                increment: 5,
