...
use egui::{Color32, Context, Painter, Pos2, Sense, Stroke, Ui, Vec2};
...
impl Go3DWireframe {
        ...
        egui::CentralPanel::default()
            ...
            .show(ctx, |ui| {
                ui.vertical_centered(|ui| {
                    // Title
                    ui.label(
                        egui::RichText::new("3D Go - Wireframe View")
                            .size(24.0)
                            .color(Color32::WHITE),
                    );
                    ...
                    ui.horizontal(|ui| {
                        ...
                        let (response, painter) =
                            ui.allocate_painter(Vec2::splat(20.0), Sense::hover());
                        ...
                        ui.add_space(20.0);
                        ui.label(
                            egui::RichText::new(format!("Stones placed: {}", self.stones.len()))
                                .color(Color32::WHITE),
                        );
                    });
                    ...
                    ui.horizontal(|ui| {
                        ui.label(
                            egui::RichText::new("Drag to rotate • Click boxes to place stones")
                                .color(Color32::GRAY),
                        );
    ...
    fn draw_3d_view(&mut self, ui: &mut Ui) {
        ...
        let size = Vec2::new(desired_size.x.min(800.0), desired_size.y.min(600.0));
    ...
    fn world_to_screen(&self, point: Point3D, center: Pos2) -> Pos2 {
        let rotated = point.rotate_y(self.rotation_y).rotate_x(self.rotation_x);
