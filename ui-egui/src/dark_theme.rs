...
use egui::{Color32, FontId, FontFamily, Rounding, Stroke, Vec2, Button, Response, Ui, Style, Visuals};
...
pub fn dark_button(ui: &mut Ui, text: &str, primary: bool) -> Response {
    ...
    let button = Button::new(text)
        .fill(fill)
        .stroke(Stroke::new(1.0, if primary { colors.primary } else { colors.border }))
