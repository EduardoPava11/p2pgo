...
use crate::ko_detector::{KoSituation, ContextMove};
...
impl KoPatternGenerator {
    ...
    fn generate_basic_ko(&self) -> GeneratedKoPattern {
        ...
        let setup_moves = vec![
            ...
            Move::Place { x: center - 1, y: center, color: Color::Black },
            Move::Place { x: center + 1, y: center, color: Color::Black },
            Move::Place { x: center, y: center - 1, color: Color::Black },
            Move::Place { x: center, y: center + 1, color: Color::Black },
            
            // White stones
            Move::Place { x: center, y: center, color: Color::White },
            Move::Place { x: center - 2, y: center, color: Color::White },
            Move::Place { x: center + 2, y: center, color: Color::White },
            Move::Place { x: center, y: center - 2, color: Color::White },
        ];
        ...
        GeneratedKoPattern {
            ...
            setup_moves,
            ko_trigger: Move::Place { x: center, y: center + 2, color: Color::White },
            ko_point: Coord::new(center, center),
            follow_up_moves: vec![
                Move::Place { x: center + 3, y: center, color: Color::Black }, // Ko threat
                Move::Place { x: center + 3, y: center + 1, color: Color::White }, // Response
                Move::Place { x: center, y: center, color: Color::Black }, // Recapture Ko
            ],
            difficulty: 1,
        }
    }
    ...
    fn generate_ladder_ko(&self) -> GeneratedKoPattern {
        ...
        let setup_moves = vec![
            // Create ladder shape
            Move::Place { x, y, color: Color::Black },
            Move::Place { x: x + 1, y, color: Color::White },
            Move::Place { x, y: y + 1, color: Color::White },
            Move::Place { x: x + 1, y: y + 1, color: Color::Black },
            Move::Place { x: x + 2, y: y + 1, color: Color::White },
            Move::Place { x: x + 1, y: y + 2, color: Color::White },
            Move::Place { x: x + 2, y: y + 2, color: Color::Black },
        ];
        ...
        GeneratedKoPattern {
            ...
            setup_moves,
            ko_trigger: Move::Place { x: x + 3, y: y + 2, color: Color::White },
            ko_point: Coord::new(x + 2, y + 2),
            follow_up_moves: vec![
                Move::Place { x: x + 4, y: y + 2, color: Color::Black },
                Move::Place { x: x + 3, y: y + 3, color: Color::White },
            ],
            difficulty: 3,
        }
    }
    ...
    fn generate_double_ko(&self) -> GeneratedKoPattern {
        ...
        let setup_moves = vec![
            ...
            // Second Ko setup
            Move::Place { x: x + 3, y, color: Color::White },
            Move::Place { x: x + 4, y: y - 1, color: Color::White },
            Move::Place { x: x + 4, y: y + 1, color: Color::White },
            Move::Place { x: x + 4, y, color: Color::Black },
            
            // Connecting stones
            Move::Place { x: x + 2, y: y - 1, color: Color::Black },
            Move::Place { x: x + 2, y: y + 1, color: Color::White },
        ];
        ...
        GeneratedKoPattern {
            ...
            setup_moves,
            ko_trigger: Move::Place { x: x + 2, y, color: Color::Black },
            ko_point: Coord::new(x + 1, y),
            follow_up_moves: vec![
                Move::Place { x: x + 5, y, color: Color::White },
                Move::Place { x: x + 4, y, color: Color::Black }, // Second Ko capture
            ],
            difficulty: 5,
        }
    }
    ...
    fn generate_corner_ko(&self) -> GeneratedKoPattern {
        let setup_moves = vec![
            // Corner setup
            Move::Place { x: 0, y: 1, color: Color::Black },
            Move::Place { x: 1, y: 0, color: Color::Black },
            Move::Place { x: 1, y: 1, color: Color::White },
            Move::Place { x: 0, y: 0, color: Color::White },
            Move::Place { x: 2, y: 0, color: Color::Black },
            Move::Place { x: 0, y: 2, color: Color::Black },
        ];
        ...
        GeneratedKoPattern {
            ...
            setup_moves,
            ko_trigger: Move::Place { x: 1, y: 2, color: Color::White },
            ko_point: Coord::new(0, 0),
            follow_up_moves: vec![
                Move::Place { x: 3, y: 0, color: Color::Black }, // Ko threat
                Move::Place { x: 3, y: 1, color: Color::White },
                Move::Place { x: 0, y: 0, color: Color::Black }, // Recapture
            ],
            difficulty: 2,
        }
    }
    ...
    fn generate_edge_ko(&self) -> GeneratedKoPattern {
        ...
        let setup_moves = vec![
            // Edge setup
            Move::Place { x: 0, y: y - 1, color: Color::Black },
            Move::Place { x: 0, y: y + 1, color: Color::Black },
            Move::Place { x: 1, y, color: Color::Black },
            Move::Place { x: 0, y, color: Color::White },
            Move::Place { x: 1, y: y - 1, color: Color::White },
            Move::Place { x: 1, y: y + 1, color: Color::White },
            Move::Place { x: 2, y, color: Color::White },
        ];
        ...
        GeneratedKoPattern {
            ...
            setup_moves,
            ko_trigger: Move::Place { x: 2, y: y - 1, color: Color::Black },
            ko_point: Coord::new(0, y),
            follow_up_moves: vec![
                Move::Place { x: 3, y, color: Color::White },
                Move::Place { x: 0, y, color: Color::Black },
            ],
            difficulty: 2,
        }
    }
    ...
    fn generate_complex_ko(&self) -> GeneratedKoPattern {
        ...
        let setup_moves = vec![
            ...
            Move::Place { x, y, color: Color::Black },
            Move::Place { x: x + 1, y, color: Color::White },
            Move::Place { x: x + 2, y, color: Color::Black },
            Move::Place { x, y: y + 1, color: Color::White },
            Move::Place { x: x + 1, y: y + 1, color: Color::Black },
            Move::Place { x: x + 2, y: y + 1, color: Color::White },
            Move::Place { x, y: y + 2, color: Color::Black },
            Move::Place { x: x + 1, y: y + 2, color: Color::White },
            Move::Place { x: x + 2, y: y + 2, color: Color::Black },
            
            // Additional stones for complexity
            Move::Place { x: x - 1, y: y + 1, color: Color::Black },
            Move::Place { x: x + 3, y: y + 1, color: Color::White },
            Move::Place { x: x + 1, y: y - 1, color: Color::Black },
            Move::Place { x: x + 1, y: y + 3, color: Color::White },
        ];
        ...
        GeneratedKoPattern {
            ...
            setup_moves,
            ko_trigger: Move::Place { x: x + 1, y: y + 4, color: Color::Black },
    ...
    pub fn pattern_to_ko_situation(&self, pattern: &GeneratedKoPattern, start_move: usize) -> KoSituation {
        let context_moves: Vec<ContextMove> = pattern.setup_moves.iter()
