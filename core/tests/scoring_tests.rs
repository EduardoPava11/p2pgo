use p2pgo_core::{Color, Coord, GameState, scoring};
...
fn test_empty_board_territory_scoring() {
    ...
    let score = scoring::calculate_final_score(&game_state, 6.5, ScoringMethod::Territory, &dead_stones);
...
fn test_simple_territory() {
    ...
    // . . . . .
    let stones = vec![
        (0, 0, Some(Color::Black)), (1, 0, Some(Color::Black)), (2, 0, Some(Color::Black)),
        (0, 1, Some(Color::Black)), (2, 1, Some(Color::Black)),
        (0, 2, Some(Color::Black)), (1, 2, Some(Color::Black)), (2, 2, Some(Color::Black)),
    ];
...
fn test_dead_stones() {
    ...
    let stones = vec![
        (0, 0, Some(Color::Black)), (1, 0, Some(Color::Black)), (2, 0, Some(Color::Black)),
        (0, 1, Some(Color::Black)), (1, 1, Some(Color::White)), (2, 1, Some(Color::Black)),
        (0, 2, Some(Color::Black)), (1, 2, Some(Color::Black)), (2, 2, Some(Color::Black)),
    ];
...
fn test_resignation_scoring() {
    ...
    let score = scoring::calculate_final_score(&game_state, 6.5, ScoringMethod::Resignation(Color::Black), &dead_stones);
    
    assert_eq!(score.final_score, 100); // Black won by resignation
    assert_eq!(score.method, ScoringMethod::Resignation(Color::Black));
    
    let score_white = scoring::calculate_final_score(&game_state, 6.5, ScoringMethod::Resignation(Color::White), &dead_stones);
...
fn test_complex_territory() {
    ...
    let stones = vec![
        (0, 0, Some(Color::Black)), (1, 0, Some(Color::Black)), (2, 0, Some(Color::Black)), 
        (3, 0, Some(Color::White)), (4, 0, Some(Color::White)),
        
        (0, 1, Some(Color::Black)), (2, 1, Some(Color::Black)), 
        (3, 1, Some(Color::White)),
        
        (0, 2, Some(Color::Black)), (1, 2, Some(Color::Black)), (2, 2, Some(Color::Black)), 
        (3, 2, Some(Color::White)), (4, 2, Some(Color::White)),
        
        (1, 3, Some(Color::White)), (2, 3, Some(Color::White)),
