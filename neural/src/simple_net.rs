...
use crate::{BoardEvaluation, MovePrediction};
            ...
            for y in 0..board_size {
                ...
                if idx < game_state.board.len() && game_state.board[idx].is_none() {
                    ...
                    if true {
                        ...
                        predictions.push(MovePrediction { coord, probability });
                    }
                }
            }
        }
            ...
            for y in 0..board_size {
                ...
                match game_state.board.get(idx) {
                    ...
                    Some(&None) | None => {
                        ...
                        let (black_influence, white_influence) =
                            self.calculate_influence(game_state, coord);
